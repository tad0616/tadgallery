                ...
                <div class="thumbnail">
                    <div class="AlbumCate">
                        ...
                        <{if $album.album_edit|default:false}>
                            <a href="<{$xoops_url}>/modules/tadgallery/ajax.php?op=edit_album&csn=<{$album.csn}>" class="btn btn-sm btn-warning fancybox fancybox.ajax editbtn" style="position:absolute;bottom:2px;right:2px;display:none;z-index:2;"><i class="fa fa-pencil" aria-hidden="true"></i>  <{$smarty.const._TAD_EDIT}></a>
                        <{/if}>
                    </div>
                </div>
            </div>
