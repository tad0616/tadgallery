...
<{if $cate.adm|default:false}>
  ...
  <a href="<{$xoops_url}>/modules/tadgallery/ajax.php?op=edit_album&csn=<{$cate.csn}>" class="btn btn-sm btn-warning fancybox fancybox.ajax editbtn" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i>  <{$smarty.const._TAD_EDIT}></a>
<{/if}>
