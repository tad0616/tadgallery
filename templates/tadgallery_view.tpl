...
<div class="row" style="background-color:#FBFBFB;">
  <div class="col-sm-<{if $width > $height}>1<{else}>2<{/if}>" style="text-align:right;">
    <{if $back|default:false}><a href="view.php?sn=<{$back}>"><img src="images/left.png" style="margin-top:100px;" alt="Back" title="Last photo"></a><{/if}>
  </div>
  ...
  <div class="col-sm-<{if $width > $height}>1<{else}>2<{/if}>">
    <{if $next|default:false}><a href="view.php?sn=<{$next}>"><img src="images/right.png" style="margin-top:100px;" alt="Next" title="Next photo"></a><{/if}>
  </div>
</div>
