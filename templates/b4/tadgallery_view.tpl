...
<div class="row" style="margin:20px 0px;">
  ...
  <div class="col-sm-6 text-right">
    <div class="btn-group">
      <{if $sel_size}>
        <a href="<{$photo_l}>" target="_blank" title="<{$description}>" class="btn btn-sm btn-secondary"><i class="fa fa-search-plus"></i> L</a>

        <a href="<{$photo_m}>" target="_blank" title="<{$description}>" class="btn btn-sm btn-secondary"><i class="fa fa-search"></i> M</a>

        <a href="<{$photo_s}>" target="_blank" title="<{$description}>" class="btn btn-sm btn-secondary"><i class="fa fa-search-minus"></i> S</a>
      <{/if}>
