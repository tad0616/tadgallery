...
<div id="jquery_tabs_tg_<{$now}>">
  ...
  <div id="upload_one_pic">
    ...
    <form action="uploads.php" method="post" id="myForm" enctype="multipart/form-data" onsubmit="return chk_csn(this.csn.value,this.new_csn.value);" role="form">

      <div class="form-group row">
        <label class="col-sm-2 col-form-label text-sm-right"><{$smarty.const._MD_TADGAL_CSN}></label>
      ...
      <div class="form-group row">
        <label class="col-sm-2 col-form-label text-sm-right"><{$smarty.const._MD_TADGAL_TITLE}></label>
        <div class="col-sm-10 controls">
      ...
      <div class="form-group row">
        <label class="col-sm-2 col-form-label text-sm-right"><{$smarty.const._MD_TADGAL_IS360}></label>
        <div class="col-sm-10 controls">
      ...
      <div class="form-group row">
        <label class="col-sm-2 col-form-label text-sm-right"><{$smarty.const._MD_TADGAL_DESCRIPTION}></label>
        <div class="col-sm-10 controls">
      ...
      <div class="form-group row">
        <label class="col-sm-2 col-form-label text-sm-right"><{$smarty.const._MD_TADGAL_TAG}></label>
        <div class="col-sm-10 controls">
  ...
  <div id="upload_pics">
    ...
    <form action="uploads.php" method="post" id="myForm_upload_pics" enctype="multipart/form-data" onsubmit="return chk_csn(this.csn.value,this.new_csn.value);" role="form">
  ...
  <div id="upload_zip_pics">
    <form action="uploads.php" method="post" id="myForm_upload_pics" enctype="multipart/form-data" role="form">
      <div class="form-group row">
        <label class="col-sm-3 col-form-label text-sm-right"><{$smarty.const._MD_TADGAL_ZIP}></label>
