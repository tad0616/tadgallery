      ...
      <div class="col-sm-3" id="item_album_<{$album.csn}>">
        <div class="thumbnail">
          <div class="AlbumCate">
            ...
            <{if $album.album_del}>
            <!--a href="javascript:delete_tad_gallery_func(<{$album.csn}>)" class="btn btn-sm btn-danger" style="position:absolute;bottom:2px;left:2px;display:none;"><{$smarty.const._TAD_DEL}></a-->
            <{/if}>
