    ...
    <div class="scroller_container_blur">
      <div class="scroller_container_shadow">
        <div class="scroller_container_shadow_content">
          <a href="<{$xoops_url}>/modules/tadgallery/view.php?sn=<{$p.photo_sn}>"><img src="<{$p.pic_url}>" alt="<{$p.photo_title}>" title="<{$p.photo_title}>" style="width:100%;" /></a>
          <div style="padding:4px;margin-top:4px;font-size:11px;color:#606060"><{$p.photo_title}></div>
          <{$p.description}>
        </div>
      </div>
    </div>
