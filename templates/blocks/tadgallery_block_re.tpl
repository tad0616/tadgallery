<{if $block.comment|default:false}>
    ...
    <ul <{if $block.showall=="0"}>style="height:2em;line-height:2em;overflow:hidden;"<{/if}>>
      <li>
        <{if $block.userinfo=="1"}>
          ...
          <a href="<{$xoops_url}>/modules/tadgallery/view.php?sn=<{$comment.nsn}>"><img src="<{$xoops_url}>/modules/tadgallery/images/image.png" hspace="4" align="absmiddle" alt="<{$comment.title}>" <{if $comment.title|default:false}>title="<{$comment.title}>"<{/if}>></a>
          :
        <{/if}>
