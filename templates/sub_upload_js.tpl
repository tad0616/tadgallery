<script type="text/javascript">
    ...
    $(document).ready(function(){
        make_option('m_csn_menu',0,0,<{if $def_csn|default:false}><{$def_csn|default:''}><{else}>0<{/if}>);
        make_option('csn_menu',0,0,<{if $def_csn|default:false}><{$def_csn|default:''}><{else}>0<{/if}>);
    });
