...
define('_MI_TADGAL_THUMBNAIL_S_WIDTH', 'Length in the long side of the small thumbnails');
define('_MI_TADGAL_THUMBNAIL_S_WIDTH_DESC', 'Set length of the longest width or height of the small thumbnails');
define('_MI_TADGAL_THUMBNAIL_M_WIDTH', 'Length in the long side of the medium thumbnails');
define('_MI_TADGAL_THUMBNAIL_M_WIDTH_DESC', 'Set length of the longest width or height of the medium thumbnails');
define('_MI_TADGAL_THUMBNAIL_B_WIDTH', 'Force the image to shrink to the specified width?');
...
define('_MI_TADGAL_THUMBNAIL_NUMBER', 'Number of images to show in a thumbnails page');
define('_MI_TADGAL_THUMBNAIL_NUMBER_DESC', 'Number of photos to show in the home page and management page');

define('_MI_TADGAL_SHOW_COPY_PIC', 'Show quick-copy button');
...
define('_MI_TADGAL_ONLY_THUMB', 'Only Thumbs');
define('_MI_TADGAL_ONLY_THUMB_DESC', ' ');

define('_MI_TADGAL_USE_PIC_TOOLBAR', 'Image toolbar?');
...
define('_MI_TADGAL_USE_THUMB_SLIDER', 'Display thumb slider?');
