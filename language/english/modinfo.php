...
define("_MI_TADGAL_ALLOW_HOTLINKING_DESC","When anti-hotlink is enabled, you can authorize special websites to link to your photo albums by entering their address here.<br />Example:\"http://www.tad0616.net\" Do not append end slash / . For more than one website, use semicolon \";\" to seperate them");
