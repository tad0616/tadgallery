...
define('_MI_TADGAL_USE_THUMB_SLIDER', '顯示縮圖滑動列？');
define('_MI_TADGAL_USE_THUMB_SLIDER_DESC', '單張相片頁面下方是否顯示縮圖滑動列？');
define('_MI_TADGAL_RANDOM_PHOTO', '是否顯示模組首頁的隨機縮圖？');
