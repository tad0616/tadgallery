...
//---模組狀態資訊---//
$modversion['release_date'] = '2013/10/18';
...
$modversion['config'][$i]['default']    = 'flickr ';
$modversion['config'][$i]['options']    = array(_MI_TADGAL_FLICKR=>'flickr',_MI_TADGAL_WATERFALL=>'waterfall');
...
$modversion['config'][$i]['options']	= array(_MI_INPUT_FORM=>'one_pic',_MI_TADGAL_MUTI_INPUT_FORM=>'batch_pics',"Flash"._MI_TADGAL_MUTI_INPUT_FORM=>'flash_batch_pics',_MI_TADGAL_JAVA_UPLOAD=>'java_batch_pics',_MI_TADGAL_ZIP_IMPORT_FORM=>'zip_batch_pics',_MI_TADGAL_XP_IMPORT_FORM=>'upload_xp_pics');
