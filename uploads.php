...
function uploads_tabs(){
  ...
  if(in_array('one_pic',$xoopsModuleConfig['upload_mode'])){
    $li_1="<li><a href='#upload_one_pic'><span>"._MA_INPUT_FORM."</span></a></li>";
  ...
  if(in_array('batch_pics',$xoopsModuleConfig['upload_mode'])){
    $li_2="<li><a href='#upload_pics'><span>"._MA_TADGAL_MUTI_INPUT_FORM."</span></a></li>";
  ...
  if(in_array('flash_batch_pics',$xoopsModuleConfig['upload_mode'])){
    $li_3="<li><a href='#upload_flash_pics'><span>Flash"._MA_TADGAL_MUTI_INPUT_FORM."</span></a></li>";
  ...
  <div id='jquery_tabs_tg_{$now}'>
    <ul>
        ...
        $li_5
        $li_6
        <li><a href='import.php#import' id='import'><span>"._TADGAL_PATCH_IMPORT_FORM."</span></a></li>
    </ul>
    $div_1
    $div_2
    $div_3
...
function tad_gallery_form($sn=""){
  ...
  <div class='controls-row'>
  	<div class='span2'>"._MA_TADGAL_CSN."</div>
  	<select name='csn' size=1 class='span5'>
  		$option
  	</select>
  	<input type='text' name='new_csn'  class='span5' placeholder='"._MA_TADGAL_NEW_CSN."'>
  </div>
  <div class='controls-row'>
  	<div class='span2'>"._MA_TADGAL_PHOTO."</div>
  ...
  <div class='controls-row'>
  	<div class='span2'>"._MA_TADGAL_DESCRIPTION."</div>
  ...
  <div class='controls-row'>
    ...
    <input type='submit' value='"._MA_SAVE."' class='btn btn-primary'>
  </div>
  </form>";
...
function tad_gallery_muti_form(){
  ...
  <table id='form_tbl' >
	...
	<td nowrap>"._MA_TADGAL_NEW_CSN."</td>
	<td><input type='text' name='new_csn' size='30'></td></tr>
	<tr><td nowrap>"._MA_TADGAL_PHOTO."</td>
	<td>
...
function tad_gallery_zip_form(){
  ...
  $main="
  <form action='{$_SERVER['PHP_SELF']}' method='post' id='myForm' enctype='multipart/form-data'>
  "._MA_TADGAL_ZIP."<input type='file' name='zipfile'>
